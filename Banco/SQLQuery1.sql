USE [master]
GO
/****** Object:  Database [Mercearia]    Script Date: 20/10/2023 08:45:40 ******/
CREATE DATABASE [Mercearia]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'mercearia', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLESXPRESS2019\MSSQL\DATA\mercearia.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'mercearia_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLESXPRESS2019\MSSQL\DATA\mercearia_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [Mercearia]
GO
/****** Object:  Table [dbo].[Cliente]    Script Date: 20/10/2023 08:45:40 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Produto]    Script Date: 20/10/2023 08:45:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 20/10/2023 08:45:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
